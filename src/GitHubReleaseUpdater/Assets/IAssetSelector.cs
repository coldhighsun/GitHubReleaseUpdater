...
/// <summary>
/// Chooses which asset of a release should be downloaded.
/// </summary>
public interface IAssetSelector
{
    /// <summary>
    /// Returns the matching asset, or null when none matches.
    /// </summary>
    GitHubAsset? Select(GitHubRelease release);
}

/// <summary>
/// Selector backed by a delegate.
/// </summary>
public sealed class DelegateAssetSelector : IAssetSelector
{
    /// <summary>
    /// The underlying selection delegate.
    /// </summary>
    private readonly Func<GitHubRelease, GitHubAsset?> _selector;

    /// <summary>
    /// Creates a selector from a delegate that receives the whole release.
    /// </summary>
    ...
    /// <summary>
    /// Creates a selector from a predicate over asset names; the first match wins.
    /// </summary>
