...
/// <summary>Snapshot of a download in progress.</summary>
...
{
    /// <summary>Completion percentage (0–100), or null when the total is unknown.</summary>
    ...
    /// <summary>Estimated remaining time, or null when unknown.</summary>
