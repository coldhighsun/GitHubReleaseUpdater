...
public sealed class GitHubRelease
{
    ...
    /// <summary>Git tag the release points at, e.g. <c>v1.2.3</c>.</summary>
    ...
    /// <summary>True for a draft release.</summary>
    [JsonPropertyName("draft")]
    public bool Draft { get; init; }

    /// <summary>True for a pre-release.</summary>
    ...
    /// <summary>Publish timestamp (null for drafts).</summary>
    ...
    /// <summary>Attached assets.</summary>
